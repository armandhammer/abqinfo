...
$familyPath='project-state/discovery/ordinary-large-campaign-family-001-2026-09-26.json'
$guardPath='tmp/ordinary-large-campaign-live-2026-09-26.json'
...
foreach($r in $family.records){
  ...
  try {
    ...
    $note='Ordinary large campaign 2026-09-26: unchanged original exact-public-byte verified; background archival only. '+$familyPath
