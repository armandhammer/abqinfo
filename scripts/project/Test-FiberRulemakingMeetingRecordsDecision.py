...
assert records['src-b8b28358abc9a2de']['r2_url'] == (archive['public_verification']['public_url'] if archive else None)
...
assert any('src-09b266eabc8aa975' in str(entry.get('resume_command', '')) for entry in [checkpoint, *checkpoint.get('history', [])])
