...
param(
  ...
  [string]$PlanPath = 'project-state/discovery/development-review-services-r2-archive-plan-2026-09-11.json',
  [string]$PublicValidationPath = 'project-state/discovery/development-review-services-r2-public-validation-2026-09-11.json'
)
