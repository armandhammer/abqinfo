...
assert a['summary']=={'source_verification_passed':7,'docx_visual_qa_pending':5,'pdf_render_qa_passed':2,'r2_key_collisions':0,'total_source_bytes':88893781}
...
print('PASS: NMDOT seven-record archive preparation preserves exact originals, source evidence, Roadway Studies placement, and the pending DOCX visual-QA gate without R2 mutation.')
