...
The 25-record Council amendment-sheet terminal family is complete in `project-state/discovery/ordinary-queue-terminal-integration-batch-2026-09-20-council-amendment-sheets.json`. The linked 11 substitute-bill family is reconciled in `project-state/discovery/council-substitute-bill-enacted-text-reconciliation-2026-09-20.json`: seven held substitutes are superseded in legal authority by identified enactments, two failed bills are excluded, and O-23-96 and R-24-17 remain requires-human-review because final disposition was not proven. The identified enactment counterparts remain unregistered inventory-only leads pending deterministic final-file capture; no archive or public action occurred. All prior external gates remain intact. After skipping gates and completed families, the next ordinary candidate is `src-09b266eabc8aa975` (a 2014 FGO agenda requiring family/minutes scoping); do not begin it in this task.
