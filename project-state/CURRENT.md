...
Capital Spending consolidation is the next ordinary-work priority, before the generic `src-05705d25113d3f2e` queue. The durable family status is `project-state/discovery/capital-spending-consolidation-status-2026-09-17.json`. The 2004, 2009, and 2011 families are complete as distinct records. The 2011 decision is at `project-state/discovery/go2011-bond-version-decision-2026-09-17.json`: December 2010 and April 2011 City editions are distinct; chronology is established but finality is not. Only the later editions remain visible. Resume the 2013 department-set edition package next; do not restart prior families or make a master record while competing-version relationships remain unresolved.
