...
The recomputed queue handoff is `project-state/discovery/ordinary-queue-next-position-2026-09-20-recomputed.json`. After removing the completed Planning residual, the next genuinely actionable ordinary family is the eight-record later MS4 annual-report and permit-instrument family beginning `src-185f33493177b085`. Its saved research is in `project-state/discovery/undiscovered-documents-research-2026-09-14.json`; this is an integration/review handoff only. The separately gated 2014 MS4 body-and-attachments family remains excluded from ordinary review. Do not fetch or research the later-MS4 family in this queue-position stage.
