...
Capital Spending consolidation is the next ordinary-work priority, before the generic `src-05705d25113d3f2e` queue. The durable family status is `project-state/discovery/capital-spending-consolidation-status-2026-09-17.json`. The 2004 family is complete as distinct records. The 2009 review is complete at `project-state/discovery/go2009-bond-version-and-duplicate-review-2026-09-17.json`: the two Streets schedules are distinct dated City editions but finality is not established, and the corrected Fire/Police/Family duplicate relationships were already recorded. Keep 2009 as distinct records. Resume 2011 next from its saved research; do not restart 2009 or make a master record while competing-version relationships remain unresolved.
