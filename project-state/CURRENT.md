...
The normal queue resumed with the complete 2013-2014 Paseo del Volcan family, beginning at `src-05705d25113d3f2e` (not an MS4 record). Its complete research, local publication decisions, and 11-object proposed archive plan are `project-state/discovery/paseo-del-volcan-cluster-research-2026-09-11.json`, `project-state/discovery/paseo-del-volcan-publication-decisions-2026-09-17.json`, and `project-state/discovery/paseo-del-volcan-r2-archive-plan-2026-09-17.json`. All eleven originals were re-fetched and exact-byte verified; eight records are excluded and one delivery copy is duplicate. Do not edit content until the plan's R2 upload and public byte verification succeed. After this coherent family is complete, resume the ordinary queue; review the 2014 MS4 family as a package when reached.
